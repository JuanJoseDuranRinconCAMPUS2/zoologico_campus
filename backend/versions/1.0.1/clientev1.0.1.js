...
export const getClientesV101 = async ( req,res)=>{
    try {
...
export const postClientesV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putClientesV101 = async (req,res)=>{
...
export const deleteClientesV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
