...
export const getHisExhibicionV101 = async ( req,res)=>{
    try {
...
export const postHisExhibicionV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putHisExhibicionV101 = async (req,res)=>{
...
export const deleteHisExhibicionV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
