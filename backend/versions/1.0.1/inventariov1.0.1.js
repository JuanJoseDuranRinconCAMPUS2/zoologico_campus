...
export const getInventarioV101 = async ( req,res)=>{
    try {
...
export const postInventarioV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putInventarioV101 = async (req,res)=>{
...
export const deleteInventarioV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
