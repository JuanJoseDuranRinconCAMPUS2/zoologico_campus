...
export const getAlimentoV101 = async ( req,res)=>{
    try {
...
export const postAlimentoV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putAlimentoV101 = async (req,res)=>{
...
export const deleteAlimentoV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
