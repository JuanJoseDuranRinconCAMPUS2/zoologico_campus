...
export const getHisMedV101 = async ( req,res)=>{
    try {
...
export const postHisMedV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putHisMedV101 = async (req,res)=>{
...
export const deleteHisMedV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
