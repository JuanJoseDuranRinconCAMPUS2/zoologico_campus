...
export const getEmpPagoV101 = async ( req,res)=>{
    try {
...
export const postEmpPagoV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putEmpPagoV101 = async (req,res)=>{
...
export const deleteEmpPagoV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
