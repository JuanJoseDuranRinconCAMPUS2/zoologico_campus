...
export const getEspecialidadV101 = async ( req,res)=>{
    try {
...
export const postEspecialidadV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putEspecialidadV101 = async (req,res)=>{
...
export const deleteEspecialidadV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
