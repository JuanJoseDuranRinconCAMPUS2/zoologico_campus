...
export const getEmpleadoV101 = async ( req,res)=>{
    try {
...
export const postEmpleadoV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putEmpleadoV101 = async (req,res)=>{
...
export const deleteEmpleadoV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
