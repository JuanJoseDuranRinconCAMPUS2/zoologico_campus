...
export const getHisAtencionV101 = async ( req,res)=>{
    try {
...
export const postHisAtencionV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putHisAtencionV101 = async (req,res)=>{
...
export const deleteHisAtencionV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
