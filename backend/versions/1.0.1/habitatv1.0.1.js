...
export const getHabitatV101 = async ( req,res)=>{
    try {
...
export const postHabitatV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putHabitatV101 = async (req,res)=>{
...
export const deleteHabitatV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
