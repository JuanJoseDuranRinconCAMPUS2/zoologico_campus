...
export const getVentasV101 = async ( req,res)=>{
    try {
...
export const postVentasV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putVentasV101 = async (req,res)=>{
...
export const deleteVentasV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
