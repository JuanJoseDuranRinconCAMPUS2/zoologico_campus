...
export const getHisMedNegativoV101 = async ( req,res)=>{
    try {
...
export const postHisMedNegativoV101 = async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putHisMedNegativoV101 = async (req,res)=>{
...
export const deleteHisMedNegativoV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
