...
export const getAnimalesV101 = async ( req,res)=>{
    try {
...
export const postAnimalesV101 =async (req,res)=>{
    try{
        if(!req.rateLimit) return;
...
export const putAnimalesV101 = async (req,res)=>{
...
export const deleteAnimalesV101 = async (req,res)=>{
    try {
        if(!req.rateLimit) return;
        let data = req.body
        let id = data.id
