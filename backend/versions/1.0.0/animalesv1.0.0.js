...
export const getAnimalesV100 = async ( req,res)=>{
    try {
...
export const postAnimalesV100 =async (req,res)=>{
    try{
...
export const putAnimalesV100 = async (req,res)=>{
...
export const deleteAnimalesV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
