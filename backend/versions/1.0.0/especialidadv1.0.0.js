...
export const getEspecialidadV100 = async ( req,res)=>{
    try {
...
export const postEspecialidadV100 = async (req,res)=>{
    try{
...
export const putEspecialidadV100 = async (req,res)=>{
...
export const deleteEspecialidadV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
