...
export const getMedicamentoV100 = async ( req,res)=>{
    try {
...
export const postMedicamentoV100 = async (req,res)=>{
    try{
...
export const putMedicamentoV100 = async (req,res)=>{
...
export const deleteMedicamentoV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
