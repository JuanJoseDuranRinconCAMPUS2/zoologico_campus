...
export const getTicketsV100 = async ( req,res)=>{
    try {
...
export const postTicketsV100 = async (req,res)=>{
    try{
...
export const putTicketsV100 = async (req,res)=>{
...
export const deleteTicketsV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
