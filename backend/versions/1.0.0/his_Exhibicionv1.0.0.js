...
export const getHisExhibicionV100 = async ( req,res)=>{
    try {
...
export const postHisExhibicionV100 = async (req,res)=>{
    try{
...
export const putHisExhibicionV100 = async (req,res)=>{
...
export const deleteHisExhibicionV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
