...
export const getHisMedV100 = async ( req,res)=>{
    try {
...
export const postHisMedV100 = async (req,res)=>{
    try{
...
export const putHisMedV100 = async (req,res)=>{
...
export const deleteHisMedV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
