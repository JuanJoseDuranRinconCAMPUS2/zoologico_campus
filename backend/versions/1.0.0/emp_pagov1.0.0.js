...
export const getEmpPagoV100 = async ( req,res)=>{
    try {
...
export const postEmpPagoV100 = async (req,res)=>{
    try{
...
export const putEmpPagoV100 = async (req,res)=>{
...
export const deleteEmpPagoV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
