...
export const getHisMedNegativoV100 = async ( req,res)=>{
    try {
...
export const postHisMedNegativoV100 = async (req,res)=>{
    try{
...
export const putHisMedNegativoV100 = async (req,res)=>{
...
export const deleteHisMedNegativoV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
