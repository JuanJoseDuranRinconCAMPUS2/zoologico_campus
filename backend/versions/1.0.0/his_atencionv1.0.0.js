...
export const getHisAtencionV100 = async ( req,res)=>{
    try {
...
export const postHisAtencionV100 = async (req,res)=>{
    try{
...
export const putHisAtencionV100 = async (req,res)=>{
...
export const deleteHisAtencionV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
