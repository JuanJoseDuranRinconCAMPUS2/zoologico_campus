...
export const getHisAlimentoV100 = async ( req,res)=>{
    try {
...
export const postHisAlimentoV100 = async (req,res)=>{
    try{
...
export const putHisAlimentoV100 = async (req,res)=>{
...
export const deleteHisAlimentoV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
