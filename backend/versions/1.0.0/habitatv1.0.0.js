...
export const getHabitatV100 = async ( req,res)=>{
    try {
...
export const postHabitatV100 = async (req,res)=>{
    try{
...
export const putHabitatV100 = async (req,res)=>{
...
export const deleteHabitatV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
