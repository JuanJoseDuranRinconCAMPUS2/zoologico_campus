...
export const getAlimentoV100 = async ( req,res)=>{
    try {
...
export const postAlimentoV100 = async (req,res)=>{
    try{
...
export const putAlimentoV100 = async (req,res)=>{
...
export const deleteAlimentoV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
