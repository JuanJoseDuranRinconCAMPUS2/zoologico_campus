...
export const getClientesV100 = async ( req,res)=>{
    try {
...
export const postClientesV100 = async (req,res)=>{
    try{
...
export const putClientesV100 = async (req,res)=>{
...
export const deleteClientesV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
