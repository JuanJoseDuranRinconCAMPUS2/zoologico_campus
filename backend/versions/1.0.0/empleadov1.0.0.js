...
export const getEmpleadoV100 = async ( req,res)=>{
    try {
...
export const postEmpleadoV100 = async (req,res)=>{
    try{
...
export const putEmpleadoV100 = async (req,res)=>{
...
export const deleteEmpleadoV100 = async (req,res)=>{
    try {
        let data = req.body
        let id = data.id
