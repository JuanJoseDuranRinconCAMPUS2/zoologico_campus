...
his_alimento.get('/v1.1.0', getLimit(), proxyAutorizacionTk, proxyEndpointVerify(0 , "his_alimento", "usuario", "1.1.0"), version({
    "1.1.0": getHisAlimentoV101
})); 
...
his_alimento.post('/v1.1.0', postAndPutLimit(600), proxyHisAlimento, proxyAutorizacionTk, proxyEndpointVerify(1 , "his_alimento", "Admin", "1.1.0"), version({
    "1.1.0": postHisAlimentoV101
}));
...
his_alimento.delete('/v1.1.0', deleteLimit() , proxyPValidateIds, proxyAutorizacionTk, proxyEndpointVerify(1 , "his_alimento", "Admin", "1.1.0"), version({
    "1.1.0": deleteHisAlimentoV101
}));
...
his_alimento.put('/v1.1.0', postAndPutLimit(600), proxyPValidateIds, proxyHisAlimento, proxyAutorizacionTk, proxyEndpointVerify(1 , "his_alimento", "Admin", "1.1.0"), version({
    "1.1.0": putHisAlimentoV101
}));
